                ...
                <div class="row">
                    <div class="col-lg-7 col-md-7 col-12 hello" style="margin: 0 auto;">
                        ...
                        <div class="contact-form-area m-top-30">
                            <h4>Tác Phẩm {{$score->image->TieuDe}} <p style="float:right;"><a class="noidung" href="GiamKhao/ChamDiemUser/xemanhdacham">Quay lại</a></p></h4>
                            <form class="form" method="post" action="GiamKhao/ChamDiemUser/{{$score->image->user->id}}/{{$score->image->TieuDeKhongDau}}{{$score->image->id}}.html">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <div class="form-group">
                                            <p><img src="upload/hinh/{{$score->image->name}}"></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="noidung">{!!$score->image->NoiDung!!}</div>
                                        </div>
                                    </div>
                                    <div class="contact-box-main m-top-30">
                            <div class="contact-title" style="padding-left: 20px;">
                                <h2 class="noidung">Bài Dự thi của Tác giả - {{$score->image->user->firstName }} {{$score->image->user->lastName}}-{{$score->image->user->address}}</h2>
                                <p>Ngày gửi:{{$score->image->created_at}}</p>
